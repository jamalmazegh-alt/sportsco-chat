...
export function PaymentSettingsPanel({ tournamentId, clubId, stripeAccountId, initial }: Props) {
  ...
  const feeCents = parsedEuros === null || parsedEuros < 0 ? 0 : Math.round(parsedEuros * 100);
  ...
  return (
    <div className="space-y-5 max-w-xl">
      ...
      <div
        className={cn("space-y-5", stripeRequired && "pointer-events-none opacity-50 select-none")}
      >
