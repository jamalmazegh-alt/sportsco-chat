...
function XIcon({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" className={className} aria-hidden="true">
      <path d="M18.244 2.25h3.308l-7.227 8.26 8.28 11.24h-6.49l-5.08-6.62-5.81 6.62H1.68l7.73-8.835L1.254 2.25H7.94l4.59 6.065 5.31-6.065zm-1.23 16.966h1.83L7.084 4.126H5.117l11.897 15.09z" />
    </svg>
  );
}
