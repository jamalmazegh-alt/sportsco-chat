...
const SPORT_TAGS: Record<string, string[]> = {
  ...
  futsal: ["positioning", "passing", "finishing", "pressing", "transition", "first_touch"],
  basketball: [
    "shooting",
    "rebounding",
    "defending",
  ...
  handball: ["shooting", "defending", "passing", "pivot_play", "fast_break", "set_play"],
  volleyball: ["serving", "reception", "setting", "attacking", "blocking", "defense"],
  rugby: ["tackling", "rucking", "passing", "kicking", "line_out", "scrum", "defending"],
  hockey: ["skating", "shooting", "passing", "defending", "puck_handling", "positioning"],
};
