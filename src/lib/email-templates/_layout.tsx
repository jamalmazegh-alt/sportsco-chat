...
export const EmailShell = ({
  ...
  const l: Locale = pickLocale(
    typeof locale === "string" ? locale : (locale as string | undefined),
  );
...
const StandardFooter = ({ locale, f }: { locale: Locale; f: (typeof FOOTER_COPY)[Locale] }) => (
  <Section style={footerWrap}>
    <Text style={tagline}>{f.tagline}</Text>
    <Text style={footerLinks}>
      <Link href={SITE_URL} style={footerLink}>
