...
> = {
  fr: {
    ...
    body: (t, c) => (
      <>
        Vous êtes maintenant coach de <strong>{t}</strong> au club <strong>{c}</strong>.
      </>
    ),
  ...
  en: {
    ...
    body: (t, c) => (
      <>
        You are now coach of <strong>{t}</strong> at <strong>{c}</strong>.
      </>
    ),
    cta: "Open the team",
  ...
  de: {
    ...
    body: (t, c) => (
      <>
        Sie sind jetzt Trainer von <strong>{t}</strong> bei <strong>{c}</strong>.
      </>
    ),
    cta: "Team öffnen",
  ...
  es: {
    ...
    body: (t, c) => (
      <>
        Ahora eres entrenador de <strong>{t}</strong> en <strong>{c}</strong>.
      </>
    ),
    cta: "Abrir el equipo",
  ...
  it: {
    ...
    body: (t, c) => (
      <>
        Ora sei allenatore di <strong>{t}</strong> presso <strong>{c}</strong>.
      </>
    ),
    cta: "Apri la squadra",
  ...
  nl: {
    ...
    body: (t, c) => (
      <>
        Je bent nu coach van <strong>{t}</strong> bij <strong>{c}</strong>.
      </>
    ),
    cta: "Team openen",
  ...
  pt: {
    ...
    body: (t, c) => (
      <>
        Agora você é treinador de <strong>{t}</strong> no <strong>{c}</strong>.
      </>
    ),
    cta: "Abrir a equipe",
