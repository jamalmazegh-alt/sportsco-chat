...
const COPY: Record<Locale, Copy> = {
  fr: {
    ...
    delay: (h) => (
      <>
        Nous avons bien reçu {/**/}votre demande et nous reviendrons vers vous sous{" "}
        <strong>{h}</strong>.
      </>
    ),
    ...
    subject: {
      contact: "Nous avons bien reçu votre message — Clubero",
      demo: "Votre demande de démo Clubero",
    },
  },
  en: {
    ...
    delay: (h) => (
      <>
        We've received your request and will get back to you within <strong>{h}</strong>.
      </>
    ),
  ...
  es: {
    ...
    delay: (h) => (
      <>
        Hemos recibido tu solicitud y te responderemos en un plazo de <strong>{h}</strong>.
      </>
    ),
    hours: "48 horas laborables",
    meantime: (url) => <>Mientras tanto, no dudes en visitar nuestro sitio {url}.</>,
    subject: {
      contact: "Hemos recibido tu mensaje — Clubero",
      demo: "Tu solicitud de demo de Clubero",
    },
  },
  de: {
    ...
    delay: (h) => (
      <>
        Wir haben Ihre Anfrage erhalten und melden uns innerhalb von <strong>{h}</strong>.
      </>
    ),
    hours: "48 Geschäftsstunden",
    meantime: (url) => <>In der Zwischenzeit können Sie gerne unsere Website besuchen: {url}.</>,
    subject: {
      contact: "Wir haben Ihre Nachricht erhalten — Clubero",
      demo: "Ihre Clubero Demo-Anfrage",
    },
  },
  it: {
    ...
    delay: (h) => (
      <>
        Abbiamo ricevuto la tua richiesta e ti risponderemo entro <strong>{h}</strong>.
      </>
    ),
    hours: "48 ore lavorative",
    meantime: (url) => <>Nel frattempo, visita il nostro sito {url}.</>,
    subject: {
      contact: "Abbiamo ricevuto il tuo messaggio — Clubero",
      demo: "La tua richiesta di demo Clubero",
    },
  },
  nl: {
    greeting: (n) => (n ? `Hallo ${n},` : "Hallo,"),
    ...
    delay: (h) => (
      <>
        We hebben uw aanvraag ontvangen en nemen binnen <strong>{h}</strong> contact op.
      </>
    ),
    hours: "48 werkuren",
    meantime: (url) => <>Bezoek ondertussen gerust onze site {url}.</>,
    subject: {
      contact: "We hebben uw bericht ontvangen — Clubero",
      demo: "Uw Clubero demo-aanvraag",
    },
  },
  pt: {
    ...
    delay: (h) => (
      <>
        Recebemos o seu pedido e responderemos em <strong>{h}</strong>.
      </>
    ),
    hours: "48 horas úteis",
    meantime: (url) => <>Entretanto, visite o nosso site {url}.</>,
    subject: {
      contact: "Recebemos a sua mensagem — Clubero",
      demo: "O seu pedido de demo Clubero",
    },
  },
};
...
const InquiryConfirmationEmail = ({ kind = "contact", name, locale }: Props) => {
  ...
  const siteLink = (
    <a href="https://www.clubero.app" style={link}>
      www.clubero.app
    </a>
  );
  return (
