...
const T = {
  fr: {
    ...
    bodyAnon:
      "Conformément à votre demande, vos données personnelles ont été anonymisées sur Clubero. Votre compte ne permet plus la connexion.",
    bodyHard:
      "Conformément à votre demande, votre compte et l'ensemble de vos données personnelles ont été supprimés de Clubero.",
  ...
  en: {
    ...
    bodyAnon:
      "As requested, your personal data has been anonymized on Clubero. Your account can no longer sign in.",
    bodyHard:
      "As requested, your account and all your personal data have been deleted from Clubero.",
