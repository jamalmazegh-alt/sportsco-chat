...
export const Route = createFileRoute("/_authenticated/admin/camps/$campId")({
  ...
  head: () => ({
    meta: [
      {
        title: i18nInstance.t("camps:meta.edit.title", { defaultValue: "Édition d'un stage – Clubero" }),
      },
    ],
  }),
});
  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-6 space-y-6">
        ...
        <div className="rounded-lg border border-emerald-500/30 bg-emerald-500/5 p-3 text-sm">
          ...
          <div className="text-xs text-muted-foreground">
            ...
            <span className="italic">
              ({t("lifecycle.publicUrlSoon", { defaultValue: "page publique bientôt disponible" })})
            </span>
          </div>
        </div>
      )}
      ...
      <section className="space-y-4 rounded-xl border border-border bg-card p-4">
        ...
        <div className="space-y-1.5">
          ...
          <p className="text-xs text-muted-foreground">
            {slugLocked
              ...
              : t("form.slugHint", {
                  defaultValue: "Lettres, chiffres et tirets. Modifiable tant que le stage est en brouillon.",
                })}
          </p>
          {slugInvalid && (
        ...
        <div>
          <Label className="mb-2 block">{t("form.cover", { defaultValue: "Image de couverture" })}</Label>
          <CampCoverUpload
            campId={campId}
        ...
        <div className="space-y-1.5">
          <Label>{t("form.paymentInstructions", { defaultValue: "Modalités de paiement" })}</Label>
          <Textarea
            rows={3}
