...
- Fonctionnalités clés :
  ...
  - Mur de communication du club : posts épinglés, @mentions des membres, accusés de lecture ("Lu par X/Y"), pièces jointes (images, fichiers, PDF), **sondages du club** (ciblage équipe/groupe/tout le club, un vote par utilisateur, option de diffusion email en parallèle, résultats en direct).
