...
function V2Benefits() {
  const { t } = useTranslation("marketing");
  const cards = [
    { icon: Megaphone, key: "b1", accent: "from-[color:var(--brand-blue)] to-[color:var(--secondary)]" },
    { icon: ClipboardList, key: "b2", accent: "from-[color:var(--primary)] to-[color:var(--brand-blue)]" },
...
function V2WhatsApp() {
  ...
  return (
    <section className="relative overflow-hidden border-b border-border/60 bg-gradient-to-br from-[#25D366]/5 via-background to-[#075E54]/5 py-20 lg:py-28">
      <div aria-hidden className="pointer-events-none absolute -top-32 -right-20 h-96 w-96 rounded-full bg-[#25D366]/15 blur-3xl" />
...
function V2Tournaments() {
  ...
  return (
    <section className="relative overflow-hidden border-b border-border/60 bg-gradient-to-br from-[color:var(--victory)]/10 via-background to-[color:var(--energy)]/10 py-20 lg:py-28">
      <div aria-hidden className="pointer-events-none absolute -top-32 -left-32 h-96 w-96 rounded-full bg-[color:var(--victory)]/20 blur-3xl" />
      <div className="relative mx-auto max-w-7xl px-5 lg:px-8">
        <div className="mx-auto max-w-2xl text-center">
        ...
        <div className="mt-8 flex flex-wrap justify-center gap-3">
          <Button asChild size="lg" className="h-12 bg-[color:var(--victory)] px-6 text-white hover:bg-[color:var(--victory)]/90">
        ...
        <div className="mt-12 grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
          {cards.map(({ icon: Icon, key }) => (
            <div key={key} className="rounded-3xl border border-border bg-card p-6">
              ...
              <h3 className="mt-4 font-display text-lg font-bold">{t(`home.v2.forwho.${key}Title`)}</h3>
              <p className="mt-2 text-sm leading-relaxed text-muted-foreground">
            ...
            <figure key={it.key} className="rounded-3xl border border-border bg-card p-6 shadow-sm">
              ...
              <figcaption className="mt-5 flex items-center gap-3 border-t border-border pt-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">{t("home.v2.testimonials.anonymous")}</p>
                </div>
              </figcaption>
            </figure>
          ))}
...
function V2Pricing() {
  const { t } = useTranslation("marketing");
  const incl = [
    t("home.v2.pricing.incl1"),
    t("home.v2.pricing.incl2"),
    t("home.v2.pricing.incl3"),
  ];
  return (
      ...
      <div className="mx-auto max-w-3xl px-5 text-center lg:px-8">
        ...
        <div className="relative mx-auto mt-10 max-w-md rounded-3xl border-2 border-primary bg-card p-8 shadow-2xl shadow-primary/10">
          ...
          <p className="mt-2 text-sm text-muted-foreground">
            ...
            <span className="font-semibold text-foreground">490 € {t("home.v2.pricing.perYear")}</span>{" "}
...
function V2FinalCTA() {
  ...
  return (
    <section className="relative overflow-hidden bg-primary py-20 text-primary-foreground lg:py-24">
      <div aria-hidden className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_center,color-mix(in_oklab,white_15%,transparent),transparent_60%)]" />
      <div className="relative mx-auto max-w-3xl px-5 text-center lg:px-8">
        ...
        <div className="mt-8 flex flex-wrap justify-center gap-3">
          ...
          <Button asChild size="lg" variant="outline" className="h-12 border-primary-foreground/30 bg-transparent px-7 text-base text-primary-foreground hover:bg-primary-foreground/10 hover:text-primary-foreground">
