...
function V2Hero() {
  ...
  return (
    <section className="relative isolate overflow-hidden bg-slate-950 text-white">
      ...
      <div
        aria-hidden
        className="absolute inset-0 -z-10 bg-gradient-to-r from-slate-950 via-slate-950/85 to-transparent"
      />
...
function SectionBadge({
  ...
  return (
    <span
      className={`inline-flex items-center gap-2 rounded-full border px-3 py-1 text-xs font-semibold uppercase tracking-wider ${tones[tone]}`}
    >
      {children}
    </span>
  );
...
function V2Problems() {
  const { t } = useTranslation("marketing");
  const items = [
    { icon: MessageCircle, key: "p1" },
    { icon: Bell, key: "p2" },
    { icon: Clock, key: "p3" },
    { icon: Mail, key: "p4" },
    { icon: Layers, key: "p5" },
    { icon: FileSpreadsheet, key: "p6" },
    { icon: Smartphone, key: "p7" },
  ];
  return (
      ...
      <div className="mx-auto max-w-7xl px-5 lg:px-8">
        <div className="mx-auto max-w-2xl text-center">
          <div className="inline-flex items-center gap-2 rounded-full border border-destructive/30 bg-destructive/10 px-3 py-1 text-xs font-semibold uppercase tracking-wider text-destructive">
            ...
            {t("home.v2.problems.kicker")}
          </div>
          <h2 className="mt-4 font-display text-3xl font-bold tracking-tight sm:text-4xl">
            {t("home.v2.problems.title")}
          </h2>
        </div>
        ...
        <div className="mt-12 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          {items.map(({ icon: Icon, key }) => (
            <div
              key={key}
              className="group rounded-2xl border border-border bg-card p-5 transition-colors hover:border-destructive/30"
            >
              <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-destructive/10 text-destructive">
                <Icon className="h-5 w-5" />
              </div>
              <p className="mt-4 text-sm font-semibold leading-snug text-foreground">
                {t(`home.v2.problems.${key}`)}
              </p>
            </div>
          ))}
        </div>
...
function V2Benefits() {
  ...
  const cards = [
    ...
    { icon: Trophy, key: "b3", accent: "from-[color:var(--victory)] to-[color:var(--energy)]" },
    { icon: Heart, key: "b4", accent: "from-[color:var(--energy)] to-[color:var(--primary)]" },
  ];
  return (
    <section className="border-b border-border/60 py-20 lg:py-28">
      <div className="mx-auto max-w-7xl px-5 lg:px-8">
        <div className="mx-auto max-w-2xl text-center">
          <h2 className="font-display text-3xl font-bold tracking-tight sm:text-4xl">
            {t("home.v2.benefits.title")}
          </h2>
          <p className="mt-4 text-muted-foreground">{t("home.v2.benefits.subtitle")}</p>
        </div>
        <div className="mt-14 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
          {cards.map(({ icon: Icon, key, accent }) => (
            <div
              key={key}
              className="group relative flex flex-col rounded-3xl border border-border bg-card p-6 transition-all duration-300 hover:-translate-y-1 hover:shadow-xl hover:shadow-primary/5"
            >
              <div
                className={`flex h-12 w-12 items-center justify-center rounded-2xl bg-gradient-to-br ${accent} text-white shadow-md`}
              >
                <Icon className="h-6 w-6" />
              </div>
              <h3 className="mt-5 font-display text-lg font-bold tracking-tight">
                {t(`home.v2.benefits.${key}Title`)}
              </h3>
              <p className="mt-2 text-sm leading-relaxed text-muted-foreground">
                {t(`home.v2.benefits.${key}Body`)}
              </p>
            </div>
          ))}
        </div>
...
function V2WhatsApp() {
  const { t } = useTranslation("marketing");
  const adds = [
    t("home.v2.whatsapp.add1"),
    t("home.v2.whatsapp.add2"),
    t("home.v2.whatsapp.add3"),
    t("home.v2.whatsapp.add4"),
    t("home.v2.whatsapp.add5"),
    t("home.v2.whatsapp.add6"),
    t("home.v2.whatsapp.add7"),
    t("home.v2.whatsapp.add8"),
  ];
  return (
    <section className="relative overflow-hidden border-b border-border/60 bg-gradient-to-br from-[#25D366]/5 via-background to-[#075E54]/5 py-20 lg:py-28">
      <div
        aria-hidden
        className="pointer-events-none absolute -top-32 -right-20 h-96 w-96 rounded-full bg-[#25D366]/15 blur-3xl"
      />
      <div className="relative mx-auto max-w-7xl px-5 lg:px-8">
        <div className="grid items-center gap-12 lg:grid-cols-[1.1fr_1fr]">
          <div>
            <div className="inline-flex items-center gap-2 rounded-full border border-[#25D366]/40 bg-[#25D366]/15 px-3 py-1 text-xs font-semibold uppercase tracking-wider text-[#075E54] dark:text-[#25D366]">
              <MessageCircle className="h-3.5 w-3.5" />
              {t("home.v2.whatsapp.kicker")}
            </div>
            <h2 className="mt-5 font-display text-3xl font-bold tracking-tight sm:text-5xl">
              {t("home.v2.whatsapp.title")}
            </h2>
            <p className="mt-4 text-lg font-semibold text-foreground/80">
              {t("home.v2.whatsapp.subtitle")}
            </p>
            <p className="mt-4 text-muted-foreground">{t("home.v2.whatsapp.body")}</p>
            <p className="mt-6 rounded-2xl border border-border bg-card p-4 text-sm font-semibold text-foreground">
              {t("home.v2.whatsapp.outro")}
            </p>
          </div>
          <div className="rounded-3xl border border-border bg-card p-6 shadow-xl shadow-[#25D366]/10">
            <p className="text-xs font-semibold uppercase tracking-wider text-muted-foreground">
              {t("home.v2.whatsapp.addsTitle")}
            </p>
...
function V2Tournaments() {
  const { t } = useTranslation("marketing");
  const features = ["f1", "f2", "f3", "f4", "f5", "f6", "f7", "f8", "f9", "f10", "f11", "f12"];
  return (
    <section className="relative overflow-hidden border-b border-border/60 bg-gradient-to-br from-[color:var(--victory)]/10 via-background to-[color:var(--energy)]/10 py-20 lg:py-28">
      <div
        aria-hidden
        className="pointer-events-none absolute -top-32 -left-32 h-96 w-96 rounded-full bg-[color:var(--victory)]/20 blur-3xl"
      />
      <div className="relative mx-auto max-w-7xl px-5 lg:px-8">
        <div className="mx-auto max-w-2xl text-center">
          <div className="inline-flex items-center gap-2 rounded-full border border-[color:var(--victory)]/40 bg-[color:var(--victory)]/15 px-3 py-1 text-xs font-bold uppercase tracking-wider text-[color:var(--victory)]">
            ...
            {t("home.v2.tournaments.kicker")}
          </div>
          <h2 className="mt-4 font-display text-3xl font-bold tracking-tight sm:text-5xl">
            {t("home.v2.tournaments.title")}
          </h2>
          <p className="mt-4 text-muted-foreground">{t("home.v2.tournaments.body")}</p>
        </div>
        ...
        <div className="mx-auto mt-12 grid max-w-5xl gap-3 sm:grid-cols-2 lg:grid-cols-3">
          {features.map((f) => (
            ...
            >
              <CheckCircle2 className="h-4 w-4 shrink-0 text-[color:var(--victory)]" />
              <span className="text-sm font-medium">{t(`home.v2.tournaments.${f}`)}</span>
            </div>
          ))}
        </div>

        <p className="mx-auto mt-12 max-w-2xl text-center text-lg font-semibold text-foreground">
          {t("home.v2.tournaments.outro")}
        </p>
        <div className="mt-8 flex flex-wrap justify-center gap-3">
          <Button
            asChild
            size="lg"
            className="h-12 bg-[color:var(--victory)] px-6 text-white hover:bg-[color:var(--victory)]/90"
          >
            <Link to="/tournaments/start">
              {t("home.v2.tournaments.cta")} <ArrowRight className="ml-1.5 h-4 w-4" />
            </Link>
          </Button>
        </div>
      </div>
      ...
      <div className="mx-auto max-w-7xl px-5 lg:px-8">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mt-3 text-xl font-semibold text-foreground/80">
            {t("home.v2.social.subtitle")}
          </p>
          <p className="mt-5 text-muted-foreground">{t("home.v2.social.body")}</p>
        </div>

        <div className="mx-auto mt-12 grid max-w-4xl gap-4 sm:grid-cols-2 lg:grid-cols-4">
          {["s1", "s2", "s3", "s4"].map((k) => (
            <div key={k} className="rounded-2xl border border-border bg-card p-5 text-center">
              <p className="text-sm font-semibold text-foreground">{t(`home.v2.social.${k}`)}</p>
            </div>
          ))}
        </div>
...
function V2ForWho() {
  const { t } = useTranslation("marketing");
  const cards = [
    { icon: Building2, key: "w1" },
    { icon: GraduationCap, key: "w2" },
    { icon: Heart, key: "w3" },
    { icon: Trophy, key: "w4" },
  ];
  return (
    <section className="border-b border-border/60 bg-muted/20 py-20 lg:py-28">
      <div className="mx-auto max-w-7xl px-5 lg:px-8">
        <div className="mx-auto max-w-2xl text-center">
          <h2 className="font-display text-3xl font-bold tracking-tight sm:text-4xl">
            {t("home.v2.forwho.title")}
          </h2>
          <p className="mt-3 text-muted-foreground">{t("home.v2.forwho.subtitle")}</p>
        </div>
          ...
          {cards.map(({ icon: Icon, key }) => (
            <div key={key} className="rounded-3xl border border-border bg-card p-6">
              ...
              <h3 className="mt-4 font-display text-lg font-bold">
                {t(`home.v2.forwho.${key}Title`)}
              </h3>
              <p className="mt-2 text-sm leading-relaxed text-muted-foreground">
                {t(`home.v2.forwho.${key}Body`)}
              </p>
            </div>
          ))}
        </div>
...
function V2Testimonials() {
  const { t } = useTranslation("marketing");
  const items = [
    { key: "t1", role: t("home.v2.testimonials.r1") },
    { key: "t2", role: t("home.v2.testimonials.r2") },
    { key: "t3", role: t("home.v2.testimonials.r3") },
    { key: "t4", role: t("home.v2.testimonials.r4") },
  ];
  return (
    <section className="border-b border-border/60 py-20 lg:py-28">
      <div className="mx-auto max-w-7xl px-5 lg:px-8">
        <div className="mx-auto max-w-2xl text-center">
          <h2 className="font-display text-3xl font-bold tracking-tight sm:text-4xl">
            {t("home.v2.testimonials.title")}
          </h2>
          <p className="mt-3 text-muted-foreground">{t("home.v2.testimonials.subtitle")}</p>
        </div>
        <div className="mt-12 grid gap-6 sm:grid-cols-2">
          {items.map((it) => (
            <figure key={it.key} className="rounded-3xl border border-border bg-card p-6 shadow-sm">
              <Quote className="h-6 w-6 text-primary/60" />
              <blockquote className="mt-3 text-base leading-relaxed text-foreground/90">
                "{t(`home.v2.testimonials.${it.key}Quote`)}"
              </blockquote>
              <figcaption className="mt-5 flex items-center gap-3 border-t border-border pt-4">
                ...
                <div>
                  <p className="text-sm font-semibold">{it.role}</p>
                  <p className="text-xs text-muted-foreground">
                    {t("home.v2.testimonials.anonymous")}
                  </p>
                </div>
              </figcaption>
            </figure>
...
function V2Pricing() {
  const { t } = useTranslation("marketing");
  const incl = [t("home.v2.pricing.incl1"), t("home.v2.pricing.incl2"), t("home.v2.pricing.incl3")];
  return (
    <section className="border-b border-border/60 bg-muted/10 py-20 lg:py-28">
      <div className="mx-auto max-w-3xl px-5 text-center lg:px-8">
        <h2 className="font-display text-3xl font-bold tracking-tight sm:text-4xl">
          {t("home.v2.pricing.title")}
        </h2>
        <p className="mt-3 text-muted-foreground">{t("home.v2.pricing.subtitle")}</p>

        <div className="relative mx-auto mt-10 max-w-md rounded-3xl border-2 border-primary bg-card p-8 shadow-2xl shadow-primary/10">
          <div className="absolute -top-3 left-1/2 -translate-x-1/2 rounded-full bg-primary px-4 py-1 text-xs font-semibold text-primary-foreground">
            {t("home.v2.pricing.badge")}
          </div>
          <div className="flex items-baseline justify-center gap-2">
            <span className="font-display text-6xl font-bold">49 €</span>
            <span className="text-muted-foreground">{t("home.v2.pricing.perMonth")}</span>
          </div>
          <p className="mt-2 text-sm text-muted-foreground">
            {t("home.v2.pricing.or")}{" "}
            <span className="font-semibold text-foreground">
              490 € {t("home.v2.pricing.perYear")}
            </span>{" "}
            <span className="inline-block rounded-full bg-primary/10 px-2 py-0.5 text-xs font-medium text-primary">
              {t("home.v2.pricing.yearlySave")}
            </span>
          </p>
          ...
          <Button asChild size="lg" className="mt-7 w-full h-12">
            <Link to="/register">{t("home.v2.pricing.cta")}</Link>
          </Button>
          <Button asChild size="sm" variant="link" className="mt-2 w-full">
            <Link to="/pricing">{t("home.v2.pricing.ctaAll")}</Link>
          </Button>
        </div>
      </div>
    </section>
...
function V2FinalCTA() {
  ...
  return (
    <section className="relative overflow-hidden bg-primary py-20 text-primary-foreground lg:py-24">
      <div
        aria-hidden
        className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_center,color-mix(in_oklab,white_15%,transparent),transparent_60%)]"
      />
      <div className="relative mx-auto max-w-3xl px-5 text-center lg:px-8">
        <h2 className="font-display text-3xl font-bold tracking-tight sm:text-5xl">
          {t("home.v2.finalCta.title")}
        </h2>
        <p className="mx-auto mt-4 max-w-2xl text-lg text-primary-foreground/90">
          {t("home.v2.finalCta.body")}
        </p>
        <div className="mt-8 flex flex-wrap justify-center gap-3">
          <Button asChild size="lg" variant="secondary" className="h-12 px-7 text-base">
            <Link to="/register">
              {t("home.v2.finalCta.cta")} <ArrowRight className="ml-1.5 h-4 w-4" />
            </Link>
          </Button>
          <Button
            asChild
          ...
          >
            <Link to="/demo">{t("home.v2.finalCta.ctaDemo")}</Link>
          </Button>
        </div>
      </div>
    </section>
...
function HomeFeatureTiles() {
  ...
  return (
    <section className="relative border-b border-border/60 overflow-hidden bg-gradient-to-br from-background via-muted/15 to-background">
      <div
        aria-hidden
        className="absolute inset-x-0 top-0 h-px bg-gradient-to-r from-transparent via-[color:var(--energy)]/40 to-transparent"
      />
        ...
        <div className="mt-12 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          {HOME_TILES.map((tile) => {
            ...
            return (
              ...
              >
                <div
                  className={`flex h-11 w-11 items-center justify-center rounded-xl bg-gradient-to-br ${tile.accent} text-white shadow-md group-hover:scale-110 transition-transform`}
                >
                  <Icon className="h-5 w-5" />
                </div>
...
export function TournamentsSection() {
  ...
  return (
    <section className="relative border-b border-border/60 overflow-hidden bg-gradient-to-br from-[color:var(--victory)]/10 via-background to-[color:var(--energy)]/10">
      <div
        aria-hidden
        className="absolute -top-32 -left-32 h-96 w-96 rounded-full bg-[color:var(--victory)]/20 blur-3xl"
      />
      <div
        aria-hidden
        className="absolute -bottom-32 -right-32 h-96 w-96 rounded-full bg-[color:var(--energy)]/20 blur-3xl"
      />
      ...
      <div className="relative mx-auto max-w-7xl px-5 py-20 lg:px-8 lg:py-28">
        <div className="grid gap-12 lg:grid-cols-12 lg:items-center lg:gap-14">
          <div className="lg:col-span-6">
            ...
            <h2 className="mt-5 font-display text-3xl font-bold tracking-tight sm:text-5xl">
              {t("tournaments.home.titlePre")}
              <span className="text-gradient-energy">{t("tournaments.home.titleHighlight")}</span>
              {t("tournaments.home.titlePost")}
            </h2>
            ...
            <div className="mt-8 flex flex-wrap items-center gap-3">
              <Button
                asChild
                size="lg"
                className="h-12 px-6 shadow-elevated hover:shadow-glow transition-shadow"
              >
                <Link to="/tournaments/start">
            ...
            <div className="relative mx-auto max-w-md">
              ...
              <div className="rounded-3xl border border-border bg-card shadow-elevated overflow-hidden">
                  ...
                  <div className="flex items-center gap-2.5">
                    ...
                    <div>
                      <p className="text-sm font-bold leading-tight">
                        {t("tournaments.home.mockTournament")}
                      </p>
                ...
                <div className="px-4 py-4 space-y-1.5">
                  {[
                    ...
                    >
                      <span
                        className={`grid h-6 w-6 place-items-center rounded-full text-[11px] font-bold ${r.top ? "bg-[color:var(--victory)] text-white" : "bg-muted text-muted-foreground"}`}
                      >
                        {r.p}
                      </span>
                ...
                <div className="border-t border-border bg-muted/30 px-4 py-3">
                  <p className="text-[10px] font-bold uppercase tracking-wider text-muted-foreground">
                    {t("tournaments.home.mockOngoing")}
                  </p>
                  <div className="mt-1.5 flex items-center justify-between gap-2">
                    ...
                    <div className="px-3 text-center">
                      ...
                      <p className="mt-0.5 text-[10px] text-[color:var(--energy)] font-bold uppercase tracking-wider">
                        68'
                      </p>
                    </div>
              ...
              <div className="absolute -top-4 -right-4 z-10 flex items-center gap-2 rounded-2xl border border-border bg-card px-3 py-2 shadow-elevated">
                ...
                <div>
                  <p className="text-[10px] uppercase tracking-wider text-muted-foreground font-semibold">
                    {t("tournaments.home.mockTeamsRegistered")}
                  </p>
              ...
              <div className="absolute -bottom-4 -left-4 z-10 inline-flex items-center gap-2 rounded-full border border-border bg-card px-3 py-1.5 shadow-elevated">
                ...
                <span className="text-[11px] font-bold uppercase tracking-wider">
                  {t("tournaments.home.mockTvAvailable")}
                </span>
              </div>
            </div>
          </div>
        ...
        <div className="grid gap-12 lg:grid-cols-12 lg:items-center lg:gap-14">
          <div className="lg:col-span-6">
            ...
            <div className="mt-8 flex flex-wrap items-center gap-3">
              ...
              <span className="text-xs text-muted-foreground">{t("whatsapp.ctaNote")}</span>
            </div>
          </div>
...
export function ClubWallSection() {
  ...
  return (
    <section className="relative border-b border-border/60 overflow-hidden bg-gradient-to-br from-[color:var(--brand-blue)]/8 via-background to-[color:var(--energy)]/8">
      <div
        aria-hidden
        className="absolute -top-32 -right-32 h-96 w-96 rounded-full bg-[color:var(--brand-blue)]/15 blur-3xl"
      />
      <div
        aria-hidden
        className="absolute -bottom-32 -left-32 h-96 w-96 rounded-full bg-[color:var(--energy)]/15 blur-3xl"
      />
      ...
      <div className="relative mx-auto max-w-7xl px-5 py-20 lg:px-8 lg:py-28">
        <div className="grid gap-12 lg:grid-cols-12 lg:items-center lg:gap-14">
          <div className="lg:col-span-6">
            ...
            <h2 className="mt-5 font-display text-3xl font-bold tracking-tight sm:text-5xl">
              {t("clubWall.titlePre")}
              <span className="text-gradient-primary">{t("clubWall.titleHighlight")}</span>
              {t("clubWall.titlePost")}
            </h2>
            <p className="mt-5 text-lg leading-relaxed text-muted-foreground">
              {t("clubWall.body")}
            </p>
            ...
            <div className="mt-8 flex flex-wrap items-center gap-3">
              ...
              >
                <Link to="/demo">
                  {t("clubWall.cta")} <ArrowRight className="ml-1.5 h-4 w-4" />
                </Link>
              </Button>
          ...
          <div className="lg:col-span-6">
            <div className="relative mx-auto max-w-md">
              <div
                ...
                style={{
                  background:
                    "linear-gradient(135deg, color-mix(in oklab, var(--brand-blue) 55%, transparent), color-mix(in oklab, var(--energy) 45%, transparent))",
                }}
              />
                  ...
                  <div className="rounded-2xl border border-border bg-card p-3">
                    <div className="flex items-start justify-between gap-2">
                      <div className="flex items-center gap-2">
                        <div className="grid h-8 w-8 place-items-center rounded-full bg-gradient-energy text-white text-xs font-bold">
                          FC
                        </div>
                        <div>
                          <p className="text-[12px] font-bold leading-tight">
                            {t("clubWall.mockPostAdminName")}
                          </p>
                          <p className="text-[10px] text-muted-foreground">
                            {t("clubWall.mockPostAdminTime")}
                          </p>
                        </div>
                      </div>
                    ...
                    <p className="mt-2 text-[13px] leading-relaxed text-foreground">
                      {t("clubWall.mockPostAdminBody")}
                    </p>
                    <p className="mt-2 text-[10px] text-muted-foreground flex items-center gap-1">
                      <Heart className="h-3 w-3 text-[color:var(--energy)]" />{" "}
                      {t("clubWall.mockPostAdminStats")}
                    </p>
                  </div>
                  ...
                  <div className="rounded-2xl border border-[color:var(--brand-blue)]/30 bg-[color:var(--brand-blue)]/5 p-3">
                    <div className="flex items-center justify-between gap-2">
                      <div className="flex items-center gap-2">
                        ...
                        <div>
                          <p className="text-[12px] font-bold leading-tight">
                            {t("clubWall.mockPostSocialName")}
                          </p>
                          <p className="text-[10px] text-muted-foreground">
                            {t("clubWall.mockPostSocialTime")}
                          </p>
                        </div>
                      </div>
                    ...
                    <p className="mt-2 text-[13px] leading-relaxed text-foreground">
                      {t("clubWall.mockPostSocialBody")}
                    </p>
                  </div>
                </div>

                <div className="flex items-center gap-2 border-t border-border bg-muted/30 px-3 py-2.5">
                  <div className="flex-1 rounded-full bg-card px-3 py-2 text-xs text-muted-foreground border border-border">
                    {t("clubWall.mockComposerPh")}
                  </div>
...
export function PlayerJournalSection() {
  ...
  return (
    <section className="relative border-b border-border/60 overflow-hidden bg-muted/20">
      <div
        aria-hidden
        className="absolute -top-32 -left-32 h-96 w-96 rounded-full bg-[color:var(--primary)]/15 blur-3xl"
      />
      <div
        aria-hidden
        className="absolute -bottom-32 -right-32 h-96 w-96 rounded-full bg-[color:var(--victory)]/15 blur-3xl"
      />
        ...
        <div className="grid gap-12 lg:grid-cols-12 lg:items-center lg:gap-14">
          <div className="lg:col-span-6 order-2 lg:order-1">
            <div className="relative mx-auto max-w-md">
              <div
                aria-hidden
                className="absolute -inset-6 -z-10 rounded-[2.5rem] opacity-50 blur-3xl bg-gradient-primary"
              />
              ...
              <div className="rounded-3xl border border-border bg-card shadow-elevated overflow-hidden">
                <div className="flex items-center gap-3 bg-gradient-to-r from-[color:var(--primary)] to-[color:var(--brand-blue)] px-4 py-3 text-white">
                  <div className="grid h-11 w-11 place-items-center rounded-2xl bg-white/20 text-base font-bold">
                    LM
                  </div>
                  <div className="flex-1 min-w-0">
                ...
                <div className="flex items-center gap-1 border-b border-border bg-muted/30 px-2 py-1.5 text-[11px] font-semibold">
                  <span className="rounded-md bg-card px-2.5 py-1 shadow-sm text-foreground">
                    {t("playerJournal.mockTabStats")}
                  </span>
                  <span className="rounded-md px-2.5 py-1 text-muted-foreground">
                    {t("playerJournal.mockTabAttendance")}
                  </span>
                  <span className="rounded-md px-2.5 py-1 text-muted-foreground">
                    {t("playerJournal.mockTabFeedback")}
                  </span>
                </div>
                ...
                <div className="grid grid-cols-4 gap-2 px-4 py-3">
                  {stats.map((s) => (
                    <div key={s.l} className="rounded-xl bg-muted/40 p-2 text-center">
                      <p className="font-display text-lg font-bold tabular-nums text-gradient-primary">
                        {s.v}
                      </p>
                ...
                <div className="px-4 pb-3">
                  <p className="text-[10px] font-bold uppercase tracking-wider text-muted-foreground mb-1.5">
                    {t("playerJournal.mockAttendanceLabel")}
                  </p>
                ...
                <div className="border-t border-border bg-muted/20 px-4 py-3 space-y-2">
                  <p className="text-[11px] font-bold text-foreground">
                    {t("playerJournal.mockFeedbackCoach")}
                  </p>
                  <p className="text-[12px] text-muted-foreground leading-relaxed">
                    {t("playerJournal.mockFeedbackBody")}
                  </p>
                  <div className="flex flex-wrap gap-1.5">
                    <span className="rounded-full bg-[color:var(--victory)]/15 px-2 py-0.5 text-[10px] font-bold text-[color:var(--victory)]">
                      + {t("playerJournal.mockFeedbackTagStrong")}
                    </span>
                    <span className="rounded-full bg-[color:var(--energy)]/15 px-2 py-0.5 text-[10px] font-bold text-[color:var(--energy)]">
                      ↗ {t("playerJournal.mockFeedbackTagWork")}
                    </span>
                  </div>
                </div>
          ...
          <div className="lg:col-span-6 order-1 lg:order-2">
            ...
            <h2 className="mt-5 font-display text-3xl font-bold tracking-tight sm:text-5xl">
              {t("playerJournal.titlePre")}
              <span className="text-gradient-primary">{t("playerJournal.titleHighlight")}</span>
              {t("playerJournal.titlePost")}
            </h2>
            <p className="mt-5 text-lg leading-relaxed text-muted-foreground">
              {t("playerJournal.body")}
            </p>
            <ul className="mt-7 space-y-3">
              {points.map((p) => (
                <li key={p.t} className="flex items-start gap-3">
            ...
            <div className="mt-8 flex flex-wrap items-center gap-3">
              ...
              >
                <Link to="/demo">
                  {t("playerJournal.cta")} <ArrowRight className="ml-1.5 h-4 w-4" />
                </Link>
              </Button>
...
export function CoachAssistSection() {
  ...
  const tasks = [
    {
      icon: Bell,
      body: t("coachAssist.mockTask1"),
      cta: t("coachAssist.mockTask1Cta"),
      accent: "text-[color:var(--energy)] bg-[color:var(--energy)]/15",
    },
    {
      icon: ClipboardList,
      body: t("coachAssist.mockTask2"),
      cta: t("coachAssist.mockTask2Cta"),
      accent: "text-[color:var(--brand-blue-deep)] bg-[color:var(--brand-blue)]/15",
    },
    {
      icon: Users,
      body: t("coachAssist.mockTask3"),
      cta: t("coachAssist.mockTask3Cta"),
      accent: "text-[color:var(--victory)] bg-[color:var(--victory)]/15",
    },
  ];
  return (
    <section className="relative border-b border-border/60 overflow-hidden bg-gradient-to-br from-[color:var(--primary)]/8 via-background to-[color:var(--brand-blue)]/8">
      <div
        aria-hidden
        className="absolute -top-32 -right-32 h-96 w-96 rounded-full bg-[color:var(--primary)]/15 blur-3xl"
      />
      <div
        aria-hidden
        className="absolute -bottom-32 -left-32 h-96 w-96 rounded-full bg-[color:var(--energy)]/15 blur-3xl"
      ...
      <div className="relative mx-auto max-w-7xl px-5 py-20 lg:px-8 lg:py-28">
        <div className="grid gap-12 lg:grid-cols-12 lg:items-center lg:gap-14">
          <div className="lg:col-span-6">
            ...
            <h2 className="mt-5 font-display text-3xl font-bold tracking-tight sm:text-5xl">
              {t("coachAssist.titlePre")}
              <span className="text-gradient-primary">{t("coachAssist.titleHighlight")}</span>
              {t("coachAssist.titlePost")}
            </h2>
            <p className="mt-5 text-lg leading-relaxed text-muted-foreground">
              {t("coachAssist.body")}
            </p>
            ...
            <div className="mt-8 flex flex-wrap items-center gap-3">
              ...
              >
                <Link to="/demo">
                  {t("coachAssist.cta")} <ArrowRight className="ml-1.5 h-4 w-4" />
                </Link>
              </Button>
            ...
            <div className="relative mx-auto max-w-md">
              ...
              <div className="rounded-3xl border border-border bg-card shadow-elevated overflow-hidden">
                <div className="bg-gradient-hero px-4 py-4">
                  <p className="text-[11px] font-bold uppercase tracking-[0.15em] text-[color:var(--energy)]">
                    Clubero · Coach
                  </p>
                  <p className="mt-1 font-display text-lg font-bold">
                    {t("coachAssist.mockTitle")}
                  </p>
                ...
                <div className="px-4 py-4">
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <p className="text-[11px] font-bold uppercase tracking-wider text-muted-foreground">
                      {t("coachAssist.mockInsightsLabel")}
                    </p>
                  </div>
                  <div className="space-y-2">
                    {tasks.map((task) => {
                      ...
                      return (
                        ...
                        >
                          <span
                            className={`grid h-8 w-8 place-items-center rounded-lg ${task.accent}`}
                          >
                            <Icon className="h-3.5 w-3.5" />
                          </span>
                          <p className="flex-1 text-[12px] font-medium leading-tight">
                            {task.body}
                          </p>
                ...
                <div className="border-t border-border bg-muted/20 px-4 py-3 space-y-2">
                  <div className="flex items-center gap-2">
                    ...
                    <p className="text-[11px] font-bold uppercase tracking-wider text-muted-foreground">
                      {t("coachAssist.mockAssistantLabel")}
                    </p>
                  </div>
...
function Hero() {
  ...
  return (
    <section className="relative overflow-hidden border-b border-border/60 bg-gradient-hero">
      ...
      />
      <div aria-hidden className="absolute inset-0 -z-10 opacity-[0.10] bg-jersey-stripes" />
      <div
        aria-hidden
        className="absolute -top-32 -right-32 h-96 w-96 rounded-full bg-[color:var(--primary)]/30 blur-3xl animate-float"
      />
      <div
        aria-hidden
        className="absolute -bottom-32 -left-32 h-96 w-96 rounded-full bg-[color:var(--brand-blue)]/30 blur-3xl"
      />
          ...
          <div className="lg:col-span-7">
            ...
            <div className="mt-8 flex flex-wrap items-center gap-3">
              <Button
                asChild
                size="lg"
                className="h-12 px-6 text-base shadow-elevated hover:shadow-glow transition-shadow"
              >
                <Link to="/register">
            ...
            <div className="mt-6 flex flex-wrap items-center gap-x-6 gap-y-2 text-xs text-muted-foreground">
              <span className="inline-flex items-center gap-1.5">
                <CheckCircle2 className="h-3.5 w-3.5 text-primary" /> {t("home.freeTrial")}
              </span>
              <span className="inline-flex items-center gap-1.5">
                <CheckCircle2 className="h-3.5 w-3.5 text-primary" /> {t("home.noCard")}
              </span>
              <span className="inline-flex items-center gap-1.5">
                <CheckCircle2 className="h-3.5 w-3.5 text-primary" /> {t("home.hostedEU")}
              </span>
            </div>
            ...
            <dl className="mt-10 grid grid-cols-3 gap-4 max-w-lg">
              {[
                ...
                <div
                  key={s.l}
                  className="rounded-2xl border border-border/60 bg-card/60 backdrop-blur px-3 py-3"
                >
              ...
              <div className="rounded-3xl border border-border bg-card p-5 shadow-elevated">
                <div className="mb-4 flex items-center justify-between">
                  <div>
                    ...
                    <p className="font-display text-base font-bold mt-0.5">U13 — vs FC Riverside</p>
                  </div>
                ...
                <div className="space-y-2">
                  {[
                    {
                      name: "Lucas M.",
                      status: t("home.heroStatusPresent"),
                      c: "bg-primary/15 text-[color:var(--secondary)]",
                    },
                    {
                      name: "Emma D.",
                      status: t("home.heroStatusPresent"),
                    ...
                    {
                      name: "Noah B.",
                      status: t("home.heroStatusMaybe"),
                      c: "bg-amber-500/15 text-amber-700",
                    },
                    {
                      name: "Léa S.",
                      status: t("home.heroStatusAbsent"),
                      c: "bg-red-500/15 text-red-700",
                    },
                    {
                      name: "Adam K.",
                      status: t("home.heroStatusPending"),
          ...
          {FEATURE_META.map((f, i) => {
            ...
            return (
              ...
              >
                ...
                />
                <div
                  className={`flex h-12 w-12 items-center justify-center rounded-2xl bg-gradient-to-br ${f.accent} text-white shadow-md group-hover:scale-110 group-hover:rotate-3 transition-transform`}
                >
                  <Icon className="h-5 w-5" />
                </div>
...
const AUDIENCE_META = [
  {
    key: "Clubs",
    icon: Trophy,
    pts: ["audClubsP1", "audClubsP2", "audClubsP3"],
    titleKey: "audClubs",
  },
  {
    key: "Coaches",
    icon: Zap,
    pts: ["audCoachesP1", "audCoachesP2", "audCoachesP3"],
    titleKey: "audCoaches",
  },
  {
    key: "Parents",
    icon: Bell,
    pts: ["audParentsP1", "audParentsP2", "audParentsP3"],
    titleKey: "audParents",
  },
  {
    key: "Players",
    icon: Activity,
    pts: ["audPlayersP1", "audPlayersP2", "audPlayersP3"],
    titleKey: "audPlayers",
  },
];
  ...
  return (
    <section className="border-b border-border/60 bg-muted/20">
      <div className="mx-auto max-w-7xl px-5 py-20 lg:px-8">
        ...
        <div className="mt-12 grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
          {(t("features.audiences", { returnObjects: true }) as { t: string; p: string[] }[]).map(
            (a, i) => {
    ...
    <section>
      <div className="mx-auto max-w-7xl px-5 py-20 lg:px-8">
        <div className="relative overflow-hidden rounded-3xl border border-border p-10 lg:p-16 text-center bg-gradient-cta shadow-elevated">
          ...
          <div
            aria-hidden
            className="absolute -top-20 -right-20 h-64 w-64 rounded-full bg-[color:var(--primary)]/40 blur-3xl"
          />
          ...
          <div className="relative">
            ...
            <p className="mx-auto mt-4 max-w-xl text-base text-white/80">{t("home.ctaFinalSub")}</p>
            <div className="mt-8 flex flex-wrap items-center justify-center gap-3">
              <Button
                asChild
                size="lg"
                className="h-12 px-6 bg-white text-[color:var(--brand-blue-deep)] hover:bg-white/90 hover:scale-105 transition-transform shadow-lg"
              >
                <Link to="/register">
                  {t("home.ctaClub")} <ArrowRight className="ml-1.5 h-4 w-4" />
                </Link>
...
function MarketingProfileSection({
  ...
  return (
    <section className={`relative border-b border-border/60 overflow-hidden ${bgClass}`}>
      <div
        aria-hidden
        className="absolute -top-32 -left-32 h-96 w-96 rounded-full bg-[color:var(--primary)]/10 blur-3xl"
      />
      <div
        aria-hidden
        className="absolute -bottom-32 -right-32 h-96 w-96 rounded-full bg-[color:var(--brand-blue)]/10 blur-3xl"
      />
      <div className="relative mx-auto max-w-3xl px-5 py-20 lg:px-8 lg:py-24 text-center">
        <div
          className={`inline-flex items-center gap-2 rounded-full border px-3 py-1 text-xs font-bold uppercase tracking-wider ${chipColorClass}`}
        >
          <ChipIcon className="h-3.5 w-3.5" />
          {chip}
        </div>
        <h2 className="mt-5 font-display text-3xl font-bold tracking-tight sm:text-5xl">{title}</h2>
...
function ProductPreview() {
  ...
  return (
    <section className="relative border-b border-border/60 overflow-hidden bg-gradient-to-br from-background via-muted/20 to-background">
      <div
        aria-hidden
        className="absolute -top-32 left-1/2 -translate-x-1/2 h-96 w-[40rem] rounded-full bg-[color:var(--brand-blue)]/15 blur-3xl"
      />
      <div className="relative mx-auto max-w-7xl px-5 py-20 lg:px-8 lg:py-28">
        <div className="mx-auto max-w-2xl text-center">
          <h2 className="font-display text-3xl font-bold tracking-tight sm:text-5xl">
        ...
        <div className="mt-14 grid gap-8 md:grid-cols-3 lg:gap-6">
          ...
          <div className="relative mx-auto w-full max-w-xs">
            <div
              ...
              style={{
                background:
                  "linear-gradient(135deg, color-mix(in oklab, var(--primary) 50%, transparent), color-mix(in oklab, var(--brand-blue) 40%, transparent))",
              }}
            />
            <div className="rounded-[2rem] border border-border bg-card p-4 shadow-elevated rotate-[-1.5deg] hover:rotate-0 transition-transform">
              ...
              <div className="rounded-2xl bg-muted/50 p-3">
                <p className="text-[10px] font-bold uppercase tracking-wider text-[color:var(--energy)]">
                  {t("home.previewMock1Avail")}
                </p>
                <div className="mt-2 flex items-center justify-between">
                  <div className="flex -space-x-2">
                    {["L", "E", "N", "H"].map((c) => (
                      <div
                        key={c}
                        className="h-6 w-6 rounded-full bg-gradient-to-br from-[color:var(--brand-blue)] to-[color:var(--secondary)] text-[10px] font-bold text-white grid place-items-center ring-2 ring-card"
                      >
                        {c}
                      </div>
                    ))}
          ...
          <div className="relative mx-auto w-full max-w-xs">
            <div
              ...
              style={{
                background:
                  "linear-gradient(135deg, color-mix(in oklab, var(--victory) 50%, transparent), color-mix(in oklab, var(--energy) 40%, transparent))",
              }}
            />
            <div className="rounded-[2rem] border border-border bg-card p-4 shadow-elevated md:translate-y-4 hover:translate-y-0 transition-transform">
              ...
              <div className="mt-3 rounded-2xl bg-muted/50 p-3">
                <p className="text-[10px] font-bold uppercase tracking-wider text-muted-foreground">
                  {t("home.previewMock2Season")}
                </p>
                <div className="mt-2 grid grid-cols-3 gap-2 text-center">
                  <div>
                    <p className="font-display text-base font-bold tabular-nums">18</p>
                    <p className="text-[9px] uppercase text-muted-foreground">Matchs</p>
                  </div>
                  <div>
                    <p className="font-display text-base font-bold tabular-nums">12</p>
                    <p className="text-[9px] uppercase text-muted-foreground">Buts</p>
                  </div>
                  <div>
          ...
          <div className="relative mx-auto w-full max-w-xs">
            <div
              ...
              style={{
                background:
                  "linear-gradient(135deg, color-mix(in oklab, var(--energy) 50%, transparent), color-mix(in oklab, var(--brand-blue) 40%, transparent))",
              }}
            />
            <div className="rounded-[2rem] border border-border bg-card p-4 shadow-elevated rotate-[1.5deg] hover:rotate-0 transition-transform">
              <div className="mb-3 flex items-center justify-between">
                <p className="text-[11px] font-bold uppercase tracking-wider text-muted-foreground">
                  {t("home.previewMock3Title")}
                </p>
              ...
              <div className="rounded-2xl border border-border bg-muted/30 p-3">
                ...
                <p className="mt-2 text-xs leading-snug text-foreground">
                  {t("home.previewMock3Post")}
                </p>
                <div className="mt-2 flex items-center gap-3 text-[11px] text-muted-foreground">
                  <span className="inline-flex items-center gap-1">
                    <Heart className="h-3 w-3 text-red-500" /> 42
                  </span>
                  <span className="inline-flex items-center gap-1">
        ...
        <div className="grid gap-6 lg:grid-cols-3">
          {PROMISE_META.map((p, i) => {
            ...
            return (
              ...
              >
                <div
                  className={`flex h-14 w-14 items-center justify-center rounded-2xl bg-gradient-to-br ${p.accent} text-white shadow-md group-hover:scale-110 group-hover:rotate-3 transition-transform`}
                >
                  <Icon className="h-6 w-6" />
                </div>
