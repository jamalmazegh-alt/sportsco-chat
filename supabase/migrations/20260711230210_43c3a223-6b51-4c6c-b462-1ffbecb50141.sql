...
BEGIN
  ...
  v_result := jsonb_build_object(
    ...
    'age_groups', COALESCE((
      ...
      FROM public.club_camp_age_groups
    ...
    'program_items', COALESCE((
      ...
      FROM public.club_camp_program_items
      WHERE camp_id = v_camp.id
    ), '[]'::jsonb),
    'documents', COALESCE((
      SELECT jsonb_agg(jsonb_build_object(
      ...
      FROM public.club_camp_documents
      WHERE camp_id = v_camp.id
    ), '[]'::jsonb),
