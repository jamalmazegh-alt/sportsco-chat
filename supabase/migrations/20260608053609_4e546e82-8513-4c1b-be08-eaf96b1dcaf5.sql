...
BEGIN
    ...
    UPDATE public.club_members
      SET roles = v_new_roles,
          role = CASE
            ...
            WHEN 'assistant_coach' = ANY(v_new_roles) THEN 'assistant_coach'::public.app_role
  ...
  ELSIF v_invite.team_id IS NOT NULL AND v_invite.role IN ('coach','admin','assistant_coach') THEN
