...
CREATE INDEX IF NOT EXISTS meeting_attendees_event_id_idx ON public.meeting_attendees(event_id);
CREATE INDEX IF NOT EXISTS meeting_attendees_club_id_idx ON public.meeting_attendees(club_id);
...
DROP POLICY IF EXISTS "meeting_attendees_staff_all" ON public.meeting_attendees;
...
DROP POLICY IF EXISTS "meeting_attendees_self_select" ON public.meeting_attendees;
CREATE POLICY "meeting_attendees_self_select"
  ON public.meeting_attendees FOR SELECT TO authenticated
  USING (user_id = auth.uid());

DROP POLICY IF EXISTS "meeting_attendees_self_update" ON public.meeting_attendees;
