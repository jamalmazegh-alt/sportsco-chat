-- Legal documents — terms v4 / privacy v4 (minor-consent alignment)
-- Aligns Privacy §4 and Terms §2: parental authority required for ALL users under 18.
-- Idempotent via ON CONFLICT. Preserves v3.

INSERT INTO public.consent_versions (kind, version, locale, required, title, content_md, published_at)
VALUES ('terms', 4, 'en', true, 'Terms of Service',
...
- You must be at least **18 years old** to create and manage an account on your own. Anyone under 18 may only use Clubero through an account created and supervised by a holder of parental authority (see §4 and the Parental Consent page).
...
INSERT INTO public.consent_versions (kind, version, locale, required, title, content_md, published_at)
VALUES ('terms', 4, 'fr', true, 'Conditions Générales d''Utilisation',
...
- Vous devez avoir au moins **18 ans** pour créer et gérer un compte par vous-même. Toute personne de moins de 18 ans ne peut utiliser Clubero que via un compte créé et supervisé par un titulaire de l'autorité parentale (voir §4 et la page Consentement Parental).
...
INSERT INTO public.consent_versions (kind, version, locale, required, title, content_md, published_at)
VALUES ('privacy', 4, 'en', true, 'Privacy Policy',
...
GDPR Article 8 allows Member States to set the minimum digital-consent age between 13 and 16 (for reference: 13 in Estonia, 15 in France, 16 in Luxembourg). Clubero deliberately applies a single, stricter standard across all countries: **any user under 18 is treated as a minor** and may only use Clubero through an account created and supervised by a holder of parental authority, who provides parental consent and may withdraw it at any time from **Profile → Privacy** or from the player's profile. We do not rely on minors self-consenting at the lower national ages. See the dedicated **Parental Consent** page.
...
INSERT INTO public.consent_versions (kind, version, locale, required, title, content_md, published_at)
VALUES ('privacy', 4, 'fr', true, 'Politique de Confidentialité',
